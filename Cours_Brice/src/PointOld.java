...
//    }
    ...
    // 7 C
    public static PointOld creationPoint(int x, int y) {
        if (x < 0 || y < 0)
            return null;
...
//    private PointOld(String name, int x, int y) {
//        this.name = name;
//        this.x=x;
//        this.y=y;
//        totalPoint++;
...
//    }
//
//    public static PointOld creationPoint(String name, int x, int y) {
//        if (x < 0 || y < 0)
//            return null;
//        return new PointOld(name, x, y);
//    }
//
//    public String toString () {
//        return "PointOld " + this.name + " numero " + this.numeroOrdre + " sur " + PointOld.totalPoint
...
//    }
    ...
    // 4
    public String toString () {
        return "PointOld numero " + this.numeroOrdre + " sur " + PointOld.totalPoint +
                " : abscisse : " + this.x + ", ordonnee : " + this.y ;
    }
    ...
    public static boolean egalite(PointOld p1, PointOld p2) {
        // 7A:  Pas besoin d'utiliser les accesseurs car les méthodes sont déjà au sein de l'objet PointOld,
    ...
    // Ne pas oublier le null-check, checker un attribut de `null` cause un crash
    // car tentative d'accès à une zone mémoire inconnue
    public boolean egalite(PointOld p1) {
        if (p1 == null){
            return false;
        }
